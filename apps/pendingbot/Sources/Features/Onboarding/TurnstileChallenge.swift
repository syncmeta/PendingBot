...
/// Turnstile JS SDK against `HostedConfig.environment.turnstileHost` (the
/// hostname registered for our site key). On a successful pass it reports
/// a short-lived (~5min) token to the caller, who forwards it to Supabase
